...
/**
 * Represents an injectable parameter. You may inject known values as well as
...
public interface Injectable {
	...
	/**
	 * Gets the value of this injectable parameter, if it represents a provided
	 * value.
	 * 
	...
	/**
	 * Gets the reference of this injectable parameter, if it represents a reference
	 * to another service.
	 * 
	...
	/**
	 * Creates an injectable parameter which represents a reference to another
	 * service.
	 * 
	 * <p>
	 * The type of the reference will be used as the type of the parameter to find
	 * the correct injection method. If the service referred to by that reference
	 * does not match the type of the method parameter (for example the reference is
	 * an implementation class while the service constructor or setter expects the
	 * superinterface), you will need to use {@link #ref(ServiceReference, Class)}
	 * instead.
	 * 
	 ...
	 * 
	 * <p>
	 * This overload is suited if you have a configuration where the reference type
	 * is a subtype of the parameter type expected by the injection method.
	 * 
	 * @param ref         the reference
