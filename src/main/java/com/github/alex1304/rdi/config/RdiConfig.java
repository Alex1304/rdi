...
/**
 * Contains all the configuration to create a service container. It stores the metadata of each service necessary to
 * achieve the dependency injection.
 *
...
public class RdiConfig {
    ...
    /**
     * Delegates the discovery of services to the given {@link ServiceFinder} and creates a config with all services
     * found.
     *
    ...
    public static class Builder {
        ...
        /**
         * Registers a new {@link ServiceDescriptor} containing all the dependency injection metadata for a particular
         * service.
         *
         * @param serviceDescriptor the service descriptor to register
         * @return this builder
         * @throws RdiException if the service represented by the given descriptor is already registered
         */
        ...
        /**
         * Delegates the discovery of services to the given {@link ServiceFinder} and registers all services found.
         *
         * @param serviceFinder the service finder
         * @return this builder
         * @throws RdiException if at least one of the services discovered by the finder is already registered.
         */
        ...
        /**
         * Builds the {@link RdiConfig} instance with all the service descriptors registered at the moment this method
         * is invoked.
         *
