...
/**
 * Refers to a specific service. A service is identified by a name and its class. As such, several services of the same
 * class may live in the application, even if they are declared as singleton, as long as they have a different name. If
 * the service name is not important in your application, you may refer to a service only by its class via {@link
 * ServiceReference#ofType(Class)}. In that case, the name of the service will be the name of the class as by {@link
 * Class#getName()}.
 *
 * <p>
 * This class implements {@link #equals(Object)} and {@link #hashCode()} on the name field only, meaning that in your
 * application you are not supposed to use two references with the same name but different classes. However, as said
...
public class ServiceReference<T> {
    ...
    /**
     * Creates a new {@link ServiceReference} with the given class. The name of the class as by {@link Class#getName()}
     * will be used as name for this reference.
     *
     * @param <T>          the generic type of the service class
     * @param serviceClass the service class
     * @return a new {@link ServiceReference}
